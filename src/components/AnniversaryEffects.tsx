...
const AnniversaryEffects = () => {
  ...
  const triggerManualPopper = (x: number, y: number) => {
    confetti({
      particleCount: 100,
      spread: 70,
...
export default AnniversaryEffects;
